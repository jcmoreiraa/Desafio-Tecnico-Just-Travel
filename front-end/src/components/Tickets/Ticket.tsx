...
<div className='flex gap-4  mx-auto justify-between '>
      <div className='w-[213px] h-[233px] relative '>
        <Image 
          ...
          fill
        />
        <p className='absolute top-3 left-3 bg-white rounded-full px-3 py-1 text-[#0A2156] text-sm'> Ingresso</p>
        <Image 
        src={"/favorite.svg"} 
        alt="Favorite Icon"
        width={24}
      ...
      <div className='flex-1  flex justify-between items-center px-6 py-4'>
        ...
        <div className='flex flex-col '>
          ...
          <p className='text-[#858FA6] text-sm self-start'>de R$ {ticket.price.full.toFixed(2)} por</p>
          ...
          <button className='mt-4 gap-3 flex px-7 py-3 bg-[#4070F4] text-white text-sm rounded hover:bg-[#3058c7] transition'
